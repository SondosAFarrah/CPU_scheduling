...
void Priority(struct SchedulerQueue* scheduler) {
    ...
    printf("\n Waiting time\n");
    for (int i = 0; i < scheduler->copyQueueSize3 ; i++) {
        printf("Process %d waiting time %d\n", scheduler->copyQueue3[i].processId,scheduler->copyQueue3[i].turnaroundTime-scheduler->copyQueue3[i].burstTime);
...
void SRTF(struct SchedulerQueue* scheduler) {
    ...
    printf("\nTurnaround time\n");
    for (int i = 0; i < scheduler->copyQueueSize4; i++) {
        printf("Process %d turnaround time %d\n", scheduler->copyQueue4[i].processId, scheduler->copyQueue4[i].turnaroundTime);
    }
...
int algorithm=-1;
    ...
    if(algorithm==0){
        printf("The Best Algorithm For Turnarround Time is RoundRobin with average turnarround time = %f",turn[0]);

    }
    if(algorithm==1){
        printf("The Best Algorithm For Turnarround Time is SJF with average turnarround time = %f",turn[1]);

    }
    if(algorithm==2){
        printf("The Best Algorithm For Turnarround Time is Priority Preemptive with average turnarround time = %f",turn[2]);

    }
    if(algorithm==3){
        printf("The Best Algorithm For Turnarround Time is SRTF with average turnarround time = %f",turn[3]);
    ...
    if(algorithm2==0){
        printf("The Best Algorithm For Waiting Time is RoundRobin with average turnarround time = %f\n",waiting[0]);

    }
    if(algorithm2==1){
        printf("The Best Algorithm For Waiting Time is SJF with average turnarround time = %f\n",waiting[1]);

    }
    if(algorithm2==2){
        printf("The Best Algorithm For Waiting Time is Priority Preemptive with average turnarround time = %f\n",waiting[2]);

    }
    if(algorithm2==3){
        printf("The Best Algorithm For Waiting Time is SRTF with average turnarround time = %f\n",waiting[3]);
